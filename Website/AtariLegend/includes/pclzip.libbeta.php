<?php
// --------------------------------------------------------------------------------
// PhpConcept Library - Zip Module 2.2-RC1
// --------------------------------------------------------------------------------
// License GNU/LGPL - Vincent Blavet - July 2004
...
//
// --------------------------------------------------------------------------------
// $Id: pclzip.lib.php,v 1.29 2004/07/22 15:38:20 vblavet Exp $
// --------------------------------------------------------------------------------
...
//      if (substr($p_filename, 0, strlen($p_remove_dir)) == $p_remove_dir)
  ...
  function privExtractByRule(&$p_file_list, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
  {
    ...
    for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++)
    {
	  ...
	  if (($v_extract) && ($v_header['compression'] != 8)) {
...
/* -----> Moved in PrivExtractByRule()
    // ----- Look for constraints
    if ($p_entry['status'] == 'ok') {

      // ----- Look for compression type
      if ($p_entry['compression'] != 8) {
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "Unsupported compression type (".$p_entry['compression'].")");

          $p_entry['status'] = "unsupported_compression";
          ...
          if (   (isset($p_options[PCLZIP_OPT_STOP_ON_ERROR]))
              ...
              PclZip::privErrorLog(PCLZIP_ERR_UNSUPPORTED_COMPRESSION,
			                       "Filename '".$p_entry['stored_filename']."' is "
				  	    	  	   ."compressed by an unsupported compression "
				  	    	  	   ."method (".$p_entry['compression'].") ");
    ...
    */
    ...
    if (file_exists($p_entry['filename']))
    {
      ...
      else if (filemtime($p_entry['filename']) > $p_entry['mtime'])
      {
        ...
        //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "Existing file '".$p_entry['filename']."' is older than the extrated one - will be replaced by the extracted one");
      }
    }
  ...
  function privCheckFileHeaders(&$p_local_header, &$p_central_header)
  {
	...
	if (($p_local_header['flag'] & 8) == 8) {
        ...
        //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, 'CRC : \''.$p_local_header['crc'].'\'');
	}
