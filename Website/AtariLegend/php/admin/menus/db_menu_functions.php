...
function menu_disk_software_list($menu_disk_id) {
    ...
    $sql_games = "SELECT game.game_id AS 'software_id',
         ...
         LEFT JOIN menu_disk_title_author
            ON (menu_disk_title_author.menu_disk_title_id = menu_disk_title.menu_disk_title_id)
         ...
         LEFT JOIN menu_disk_title_game
            ON (menu_disk_title.menu_disk_title_id = menu_disk_title_game.menu_disk_title_id)
         ...
         WHERE menu_disk_title.menu_disk_id = '$menu_disk_id' AND menu_disk_title.menu_types_main_id = '1'
    ...
    $sql_demos = "SELECT demo.demo_id AS 'software_id',
         ...
         LEFT JOIN menu_disk_title_demo
            ON (menu_disk_title.menu_disk_title_id = menu_disk_title_demo.menu_disk_title_id)
         ...
         LEFT JOIN menu_types_main ON (menu_disk_title.menu_types_main_id = menu_types_main.menu_types_main_id)
         WHERE menu_disk_title.menu_disk_id = '$menu_disk_id' AND menu_disk_title.menu_types_main_id = '2'
         ORDER BY demo.demo_name ASC";
    ...
    $sql_tools = "SELECT tools.tools_id AS 'software_id',
         ...
         LEFT JOIN menu_disk_title_author
            ON (menu_disk_title_author.menu_disk_title_id = menu_disk_title.menu_disk_title_id)
         LEFT JOIN menu_disk_title_set
            ON (menu_disk_title_set.menu_disk_title_id = menu_disk_title.menu_disk_title_id)
         LEFT JOIN menu_disk_title_tools
            ON (menu_disk_title.menu_disk_title_id = menu_disk_title_tools.menu_disk_title_id)
...
function menu_disk_doc_list($menu_disk_id) {
    ...
    $sql_doc_games = "SELECT game.game_name AS 'software_name',
        ...
        LEFT JOIN menu_disk_title_author
            ON (menu_disk_title_author.menu_disk_title_id = menu_disk_title.menu_disk_title_id)
        LEFT JOIN menu_disk_title_doc_games
            ON (menu_disk_title.menu_disk_title_id = menu_disk_title_doc_games.menu_disk_title_id)
        ...
        LEFT JOIN game_release ON (game_release.game_id = game.game_id)
        LEFT JOIN menu_types_main ON (menu_disk_title.menu_types_main_id = menu_types_main.menu_types_main_id)
        WHERE menu_disk_title.menu_disk_id = '$menu_disk_id' AND menu_disk_title.menu_types_main_id = '6'
        ORDER BY game.game_name ASC";
    ...
    $sql_doc_tools = "SELECT tools.tools_name AS 'software_name',
        ...
        LEFT JOIN menu_disk_title_author
            ON (menu_disk_title_author.menu_disk_title_id = menu_disk_title.menu_disk_title_id)
        LEFT JOIN menu_disk_title_doc_tools
            ON (menu_disk_title.menu_disk_title_id = menu_disk_title_doc_tools.menu_disk_title_id)
