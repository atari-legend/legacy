...
{
	$sdbquery = $mysqli->query("UPDATE menu_types_main SET menu_types_text = '$menus_type_name' WHERE menu_types_main_id = $menus_type_id")
				or die("Couldn't Update the menus type");
