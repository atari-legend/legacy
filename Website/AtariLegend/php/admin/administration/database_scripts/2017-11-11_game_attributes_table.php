<?php
/***************************************************************************
*                                2017-11-11_game_attributes_table.php
*                            -----------------------
*   begin                : 2017-11-11
...
$update_description = "Create game_attributes table";
...
CREATE TABLE `game_attributes` (
  `game_attributes_id` int(11) NOT NULL AUTO_INCREMENT,
  `attribute_type_id` int(11) NOT NULL,
  `game_id` int(11) NOT NULL,
  PRIMARY KEY (`game_attributes_id`),
  KEY `game_id` (`game_id`)
