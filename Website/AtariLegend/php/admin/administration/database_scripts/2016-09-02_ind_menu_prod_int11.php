...
// Database change 
$database_update_sql = "ALTER TABLE `ind_menu_prod` CHANGE `ind_menu_prod_id` `ind_menu_prod_id` INT(11) NULL DEFAULT NULL, CHANGE `ind_id` `ind_id` INT(11) NULL DEFAULT NULL, CHANGE `menu_sets_id` `menu_sets_id` INT(11) NULL DEFAULT NULL; ";
