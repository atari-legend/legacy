<?php
/***************************************************************************
*                                2017-11-15_attribute_category_table.php
*                            -----------------------
*   begin                : 2017-11-15
...
$update_description = "Create attribute category table";
...
// Database change
$database_update_sql = "CREATE TABLE `attribute_category` (
  `attribute_category_id` int(11) NOT NULL AUTO_INCREMENT,
