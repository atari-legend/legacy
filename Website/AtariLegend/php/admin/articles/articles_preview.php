...
$query_author = $mysqli->query("SELECT userid, email FROM users WHERE user_id = $query_article[user_id]") or die("couldn't get author of article");
$sql_author = $query_author->fetch_array(MYSQLI_BOTH);

$smarty->assign('article', array(
    'article_title' => $query_article['article_title'],
