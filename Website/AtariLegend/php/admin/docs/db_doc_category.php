...
{
  $sdbquery = $mysqli->query("UPDATE doc_category SET doc_category_name = '$doc_category_name' WHERE doc_category_id = $doc_category_id")
        or die("Couldn't Update the doc category");
