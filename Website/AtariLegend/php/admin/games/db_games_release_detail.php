...
if (isset($action) && ($action == 'general')) {
    ...
    if ($submit_type == "save_and_back") {
        ...
        header("Location: ../games/games_release_detail.php?game_id=$game_id&release_id=$release_id&tab=$tab");
    }
}
...
if (isset($action) and $action == 'game_release_aka') {
    ...
    header("Location: ../games/games_release_detail.php?game_id=$game_id&release_id=$game_release_id&tab=general");
}
...
if (isset($action) && ($action == 'features')) {
    ...
    if ($submit_type == "save_and_back") {
        ...
        header("Location: ../games/games_release_detail.php?game_id=$game_id&release_id=$release_id&tab=compatibility");
    }
}
...
if (isset($action) && ($action == 'scene')) {
    ...
    if ($submit_type == "save_and_back") {
        ...
        header("Location: ../games/games_release_detail.php?game_id=$game_id&release_id=$release_id&tab=scene");
    }
}
...
if (isset($action) && ($action == 'add_media')) {
    ...
    $mediaDao->addMediaToRelease($release_id, $media_type_id, $media_label);
