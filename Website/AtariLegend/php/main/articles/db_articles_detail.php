...
if (isset($action)) {
    if ($action=='delete_comment') {
        ...
        $sql = $mysqli->query("DELETE FROM article_user_comments WHERE comments_id = '$comment_id'") or die("couldn't delete article_comment quote");
        ...
        $mysqli->query("INSERT INTO article_user_comments (article_id, comments_id) VALUES ('$article_id', '$new_comment_id')") or die("Inserting the comment failed");
