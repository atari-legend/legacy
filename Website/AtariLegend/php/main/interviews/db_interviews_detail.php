...
if (isset($action)) {
    if ($action=='delete_comment') {
        ...
        $sql = $mysqli->query("DELETE FROM interview_user_comments WHERE comment_id = '$comment_id'") or die("couldn't delete game_comment quote");
        ...
        $mysqli->query("INSERT INTO interview_user_comments (interview_id, comment_id) VALUES ('$interview_id', '$new_comment_id')") or die("Inserting the comment failed");
