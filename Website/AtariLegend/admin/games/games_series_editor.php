	...
	// SERIES LIST DROPDOWN
				...
				$sql_series_link = $mysqli->query("SELECT game.game_id,
							   ...
							   game_year.game_year
								...
								WHERE game_series_cross.game_series_id='$game_series_id' GROUP BY game.game_name ORDER BY game.game_name")
				 		   		 	or die ("Couldn't query Game Series Database3.1");
...
$smarty->display('file:../templates/0/games_series_editor.html');
?>
