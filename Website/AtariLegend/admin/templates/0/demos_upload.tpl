 ...
 *
 *   Id: demos_upload.tpl,v 0.10 2005/11/12 17:15 ST Gravedigger
 *
 ***************************************************************************/
...
function delete_download(id, demo_id)
{ 
    	...
    	if (return_value !="0")
    	{
    		url="../demos/demos_upload.php?demo_id="+demo_id+"&demo_download_id="+id+"&action=delete_download";
			location.href=url;
    	} 
}
</script>
...
<tr>
	...
	&nbsp;Upload file for <a href="../demos/demos_detail.php?demo_id={$demo.demo_id}" class="MAINNAV_WHITE">{$demo.demo_name}</a>
	</td>
</tr>
</table>
...
<tr>
	...
	<fieldset class="category_set">
		In this section you can upload a download for <b><a href="../demos/demos_detail.php?demo_id={$demo.demo_id}" class="MAINNAV">{$demo.demo_name}</a></b>.	Make sure to give 
		every version a different set nr. If a demo has 2 disks, those 2 disks should have equal
		set nr's. set nrs are linked to the version/crack you upload. If you upload 2 different 
		cracks with the same set_nr for a certain demo, it all gets screwed! so make sure you do it 
		correctly!
	</fieldset> 
	</td>
</tr>
...
<tr>
	<td>
	<form action="../demos/demos_upload.php?action=update_download" method="post" name="upload">
	<fieldset class="game_set">
		<legend class="links_legend">{$line.date}</legend>
		<table width="100%">
		<tr>
			<td colspan="4">
				<a href="{$line.filepath}.zip" class="MAINNAV">{$line.filename}</a>
				<br>
				<br>
			</td>
		</tr>	
		...
		<tr>
			<td colspan="4">
				<br>
				<br>
				<input type="hidden" name="demo_download_id" value="{$line.demo_download_id}">
				<input type="hidden" name="demo_id" value="{$demo.demo_id}">
				<input type="button" value="Delete" onClick="delete_download({$line.demo_download_id},{$demo.demo_id});">
...
<tr>
	<td>
	<form action="../demos/demos_upload.php?action=add_download" enctype="multipart/form-data" method="post" name="add_file">
	<fieldset class="category_set">
		<legend class="links_legend">Add a new download</legend>
		<table>
		<tr>
			<td>
				<b>Filename :</b> <input type="file" name="demo_download_name" accept="application/x-zip-compressed,application/x-zip-compressed,application/x-zip-compressed">
			</td>
		</tr>
		<tr>
			<td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
   		<td colspan="3" valign=top align=center>
			<b><a href="../demos/demos_detail.php?demo_id={$demo.demo_id}" class="MAINNAV">back</a></b>
		</td>
	</tr>
</table>
<br>
