...
function setsmileyn(text) {
	if (document.post.textfield.createTextRange && document.post.textfield.caretPos) {
		var caretPos = document.post.textfield.caretPos;
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else document.post.textfield.value += text;
	document.post.textfield.focus(caretPos)
}

function setsmileyn2(text) {
	if (document.post.textintro.createTextRange && document.post.textintro.caretPos) {
		var caretPos = document.post.textintro.caretPos;
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else document.post.textintro.value += text;
	document.post.textintro.focus(caretPos)
}
//-->
