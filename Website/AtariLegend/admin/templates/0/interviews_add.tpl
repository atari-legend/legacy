...
*
*   Id: interviews_add.tpl,v 0.10 2005/07/30 23:12 Gatekeeper
*
***************************************************************************/
...
{	
	...
	if (return_value !="0")
    {
      	url="interviews_add.php?interview_id="+interview_id+"&screenshot_id="+screenshot_id+"&action=delete_comment";
		location.href=url;
    }
}
</script>
...
<form action="../interviews/interviews_add.php" method="post" name="post">
...
<tr>
	...
	<span class="LEFTNAVHEADING">&nbsp;Add Interviews - <a href="../administration/construction.php" class="MAINNAV_WHITE">{$selected_individual.ind_name}</a></span>
	</td>
</tr>
</table>
...
<tr>
	...
	<tr>
		<td width="100%">
			<textarea name="textintro" ONSELECT="javascript:storeCaret(this);" ONCLICK="javascript:storeCaret(this);" ONKEYUP="javascript:storeCaret(this);" ONCHANGE="javascript:storeCaret(this);" rows="5" class="textarea_interviews">
			</textarea>
		</td>
	</tr>				
	<tr>
	...
	<tr>
		<td width="100%">
			<textarea name="textchapters" ONSELECT="javascript:storeCaret(this);" ONCLICK="javascript:storeCaret(this);" ONKEYUP="javascript:storeCaret(this);" ONCHANGE="javascript:storeCaret(this);" rows="5" class="textarea_interviews">
			</textarea>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="100%">
			<textarea name="textfield" ONSELECT="javascript:storeCaret(this);" ONCLICK="javascript:storeCaret(this);" ONKEYUP="javascript:storeCaret(this);" ONCHANGE="javascript:storeCaret(this);" rows="15" class="textarea_interviews">
			</textarea>
		</td>
	</tr>
	</table>	
	...
	<tr>
		<td valign="top" width="100%">
			...
			<input type="submit" name="Create Interview" value="Create Interview">
		</td>
	</tr>
	</table>	
	</td>
