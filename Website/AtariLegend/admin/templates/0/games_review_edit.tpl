...
{	
	...
	if (return_value !="0")
    {
      	url="games_review_edit.php?reviewid="+reviewid+"&gameid="+gameid+"&action=delete_review";
		location.href=url;
    }
}
...
{	
    ...
    // OTHERWISE IT RETURN FALSE
	 ...
	 if (return_value !="0")
     {
      	url="games_review_edit.php?game_id="+game_id+"&reviewid="+reviewid+"&screenshot_id="+screenshot_id+"&action=delete_comment";
		location.href=url;
     }
}
</script>
...
<form action="../games/games_review_edit.php" method="post" name="post">
...
<tr>
	...
	<span class="LEFTNAVHEADING">&nbsp;Edit review - <a href="../games/games_detail.php?game_id={$game.game_id}" class="MAINNAV_WHITE">{$game.game_name}</a></span>
	</td>
</tr>
</table>
...
<tr>
	...
	<tr>
		...
		<td width="10%" align="left">
			<input type="text" name="graphics" class="gamescore" value="{$edit_review.review_graphics}">
		</td>
		<td width="15%" align="right">
			<b>Sound :</b> &nbsp;
		</td>
		<td width="10%" align="left">
			<input type="text" name="sound" class="gamescore" value="{$edit_review.review_sound}">
		</td>
		<td width="15%" align="right">
			<b>Gameplay :</b> &nbsp;
		</td>
		<td width="10%" align="left">
			<input type="text" name="gameplay" class="gamescore"  value="{$edit_review.review_gameplay}">
		</td>
		<td width="15%" align="right">
			<b>Conclusion :</b> &nbsp;
		</td>
		<td width="10%" align="left">
			<input type="text" name="conclusion" class="gamescore"  value="{$edit_review.review_overall}">
		</td>
	</tr>
	</table>	
	<table width="100%" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		<td valign="top" width="100%">
			...
			<input type="submit" name="Create Review" value="Edit Review">
			<input type="button" name="delete" value="Delete review" onclick="deletereview({$reviewid},{$game.game_id})">
		</td>
	</tr>
	</table>	
	</td>
