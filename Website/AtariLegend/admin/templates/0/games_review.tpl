...
*						   Created file
*						
*   Id: games_music.tpl,v 0.10 2005/11/27 ST Graveyard
*
***************************************************************************/
...
<tr>
	...
	<span class="LEFTNAVHEADING">&nbsp;Add/Edit a game review entry</span>
	</td>
</tr>
</table>
...
<tr>
	...
	<fieldset class="category_set">
		In this section you can add or edit game reviews. There are currently <b>{$review_nr}</b> in the DB!
	</fieldset> 
	</td>
</tr>
<tr>
	<td align="center">
		<form action="../games/games_review.php" method="post" name="game_review" id="game_review">
		<fieldset class="interview_set">
		<legend class="links_legend">Search review</legend>
		<br>
		<table>
		<tr>
			<td>
